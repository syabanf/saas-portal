...
export function InvoiceDocumentPage() {
  const { id = '' } = useParams()
  const { state, invoicesById, tenantsById, subscriptionsById, applicationsById, payments } =
    useScoped()
      ...
      <InvoiceDocument
        ...
        notes={[
          ...(subscription
            ...
            : []),
          `This invoice was generated by ${platform.brandName}. Reply to ${platform.billingEmail} for questions.`,
        ]}
      />
